...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public boolean login(Authentication authentication) {
        ...
        if (storedHash == null || storedHash.isEmpty()) return false;
        			//AQUI DEBERÍA LLAMARSE AL SERVICIO
        			//UserAplicationService
        			//CON EL MÉTODO  checkPassword()
//        boolean matches = passwordEncoder.matches(rawPassword, storedHash);
        boolean matches = userAplicationService.checkPassword(rawPassword, storedHash);
